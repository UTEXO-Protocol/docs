...
<CardGroup cols={2}>
  ...
  <Card title="RGB Lightning Node API" icon="bolt" href="/rgb-lightning-node/rgb-lightning-node-api">
...
| --- | --- | --- |
| RGB Lightning Node | [RGB Lightning Node API](/rgb-lightning-node/rgb-lightning-node-api) | [OpenAPI specification](https://github.com/UTEXO-Protocol/rgb-lightning-node/blob/dev/openapi.yaml) |
