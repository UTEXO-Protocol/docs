...
The TypeScript integration uses `preparePermit2Approval` from `@hot-pot/hotpot-sdk-ts`; preserve that package name when implementing against the current SDK.
