---
title: 'What is Utexo?'
description: 'Utexo is a Bitcoin-native execution and settlement layer for stablecoin payments — enabling predictable costs, private execution, and trustless settlement through a single API integration.'
sidebarTitle: 'What Utexo Is'
---
...
<CardGroup cols={2}>
  ...
  <Card title="Product Suite" icon="cubes" href="/product-suite">
    Explore the SDK, Cloud Modules, Bridge, and AMM DEX that make up the Utexo product surface.
  </Card>
</CardGroup>
