...
You can also check node version status and trigger upgrades programmatically using the Cloud API. Refer to the [Cloud API](/access-token-authorization/cloud-api) reference for the relevant endpoints.