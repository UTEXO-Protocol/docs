...
- An **`X-Utexo-Signature` header** containing a cryptographic signature
...
2. **Verify the signature** — Validate the `X-Utexo-Signature` header using the public key on every request.
