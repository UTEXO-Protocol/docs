...
With an open Lightning channel, you can send and receive payments using `createLightningInvoice` and `payLightningInvoice`.
...
- [SDK Reference](/product-suite/sdk) — Full method reference for `UTEXOWallet`, including Lightning channel management and backup
