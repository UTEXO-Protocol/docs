...
| `@utexo/wdk-wallet-rgb` | Node.js & Bare | WDK-compatible RGB asset management for wallet builders |
| `@utexo/wdk-rgb-lightning` | Node.js & Bare | WDK-compatible RGB Lightning channels and payments |
