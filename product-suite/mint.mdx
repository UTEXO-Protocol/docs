...
| --- | --- | --- |
| Bitcoin (RGB layer) | Taproot / Schnorr / Segwit | Inbound & Outbound |
| Lightning | Taproot / Schnorr / Segwit | Inbound & Outbound |
...
| --- | --- | --- |
| USDT | Bitcoin (RGB layer), Lightning | USDT on Bitcoin |
| USDT0 | Arbitrum (native Hub), other EVM, Tron, Solana (via bridge) | USDT on Bitcoin |
