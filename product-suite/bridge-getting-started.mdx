...
1. **Enter the transfer details**
   ...
   - **Enter the destination address** — In the Destination field, paste an RGB invoice generated in the IRIS Wallet mobile app:
     ...
     - Open the IRIS Wallet mobile app.
     - Go to the **Receive** section and tap on **RECEIVE ASSETS**.
     - Select the **TUSDT** token from the token list.
     - Copy the invoice displayed in the IRIS Wallet.
     - Paste the RGB invoice into the Destination field of the Utexo Bridge form.
