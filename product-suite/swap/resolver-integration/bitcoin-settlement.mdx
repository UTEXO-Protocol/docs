...
- The internal key may be a NUMS point or a resolver-selected key. RGB USDT swaps use a NUMS internal key; see [RGB USDT in Utexo Swap](/product-suite/swap/rgb#for-resolvers).
...
<Warning>
  The deposit transaction has two or three outputs. Confirm the purpose of the optional third output with Utexo before adding change outputs.
</Warning>
...
<Note>
  Confirm the final witness stack for the timelock refund path with Utexo before constructing this witness.
</Note>
