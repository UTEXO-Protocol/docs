...
### GET /networks/{id}/supported-tokens
...
### GET /transfers/estimate/{sender-network}/{recipient-network}/{token-id}/{amount}
...
### POST /transfers/mint-in-signature
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `authenticationSignature` | string | Yes | Authentication signature (see [Authentication](#authentication)) |
...
| `transferId` | string | Yes | Transfer ID from `POST /transfers/mint-in-signature` |
...
### GET /transfers/invoice/{tx-id}/{network-id}
