...
<Info>
  This guide is a **UI walkthrough** for using the Utexo Mint interface. If you want to initiate a bridge programmatically using the SDK or REST API, see the [Mint API Reference](/product-suite/mint-api-reference) instead.
</Info>
